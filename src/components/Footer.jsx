  ...
  return (
    <footer className='w-full bg-[#224B21] text-white flex justify-center pt-16 pb-5'>
      ...
      <div className='w-[1200px] grid grid-cols-2 gap-y-14'>
        ...
        <div className=''>
          <h3 className='text-center text-xl font-bold mb-4'>Entre em contato para encontrar seu imóvel ideal!</h3>
          ...
          <div className='flex gap-4 justify-center '>
            ...
            <div className="relative flex items-center justify-center group">
              <div
                className={`absolute bottom-16 bg-gray-800 text-white text-sm px-3 py-1 rounded-md shadow-md opacity-0 translate-y-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0 ${showTooltip ? "opacity-100 translate-y-0" : ""
                  }`}
              >
        ...
        <div className='w-full col-span-2 justify-self-center'>
          ...
          <h2 className='text-center text-3xl font-medium mb-4'>Venha nos visitar!</h2>
          <iframe
        ...
        <div className='text-center col-span-2'>
          <p>CRECI: 552-J</p>
          <p>&copy; {new Date().getFullYear()} Santos Corretora. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  )
